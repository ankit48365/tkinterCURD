...
Label(root, text="Location Details", fg="black", font=(None, 18)).place(x=620, y=10)

Label(root, text="STATION_NAME").place(x=10, y=10)
...
Button(root, text="Add",command = Add,height=2, width= 12).place(x=30, y=140)
Button(root, text="Update",command = update,height=2, width= 12).place(x=140, y=140)
Button(root, text="Delete",command = delete,height=2, width= 12).place(x=250, y=140)
Button(root, text="Show",command = show,height=2, width= 12).place(x=360, y=140)
# Button(root, text="Clear",command = clean,height=2, width= 12).place(x=470, y=140)
